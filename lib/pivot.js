...
function loadTemplateColumns(end){
  ...
  mongodb[collection].find({ _tags: { $all: ['template'] } } , function (err, data0){
    ...
    for(var t in templates){
      ...
      var template = templates[t]._template || [];
...
// exports.update('contracts', ["_tags","customer","direction","tariff","type","volume"], '../../db/pivot.sqlite3', function(){
//   console.log('done.')
// });
